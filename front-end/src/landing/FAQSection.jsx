export default function FAQSection(){
  ...
  <h2 className="text-base font-semibold leading-7 text-indigo-600 text-center">Good to know</h2>

      <h2 className="mb-8 text-4xl text-center tracking-tight font-extrabold text-gray-900 dark:text-white">Frequently asked questions</h2>
