      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <h2 className="text-base font-semibold leading-7 text-indigo-600 text-center">Lifetime of growth</h2>
          ...
          <p className="mt-6 text-lg leading-8 text-gray-600">
            Users will be on a yearly subscription to our software to help them connect to others. 
          </p>
        </div>
          ...
          <div className="-mt-2 p-2 lg:mt-0 lg:w-full lg:max-w-md lg:flex-shrink-0">
            <div className="rounded-2xl bg-gray-50 py-10 text-center ring-1 ring-inset ring-gray-900/5 lg:flex lg:flex-col lg:justify-center lg:py-16">
              <div className="mx-auto max-w-xs px-8">
                <p className="text-base font-semibold text-gray-600">Pay once Yearly</p>
