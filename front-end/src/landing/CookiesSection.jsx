    ...
    <section className="fixed bottom-0 w-full bg-gray-50 dark:bg-gray-800">
      <div className="container px-4 py-8 mx-auto lg:flex lg:items-center lg:gap-x-16">
        ...
        <div className="flex items-center mt-6 gap-x-4 lg:gap-x-8 shrink-0 lg:mt-0">
          ...
          <button className="text-sm w-1/2 md:w-auto font-medium bg-gray-900 rounded-lg hover:bg-gray-900/80 text-white px-4 py-2.5 duration-300 transition-colors focus:outline-none" onClick={handleAcceptCookies}>
            Accept All Cookies
          </button>
        </div>
      </div>
