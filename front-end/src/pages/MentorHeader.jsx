    ...
    const {user} = useContext(UserContext);
      return(
          <header className="flex justify-between py-6 px-8">
              ...
              <Link to={'/mentor-account-page'} className="flex items-center gap-2 border border-gray-300 rounded-full py-2 px-4 ">
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
                  <path strokeLinecap="round" strokeLinejoin="round" d="M3.75 6.75h16.5M3.75 12h16.5m-16.5 5.25h16.5" />
                  </svg>
                  <div className="bg-gray-900 text-white rounded-full border border-gray-900 overflow-hidden">
