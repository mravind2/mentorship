...
<svg xmlns="http://www.w3.org/2000/svg" class="h-24 w-24" viewBox="0 0 20 20" fill="currentColor">
  ...
  <div className="mt-20 text-center border-b pb-12">
    <h1 className="text-4xl font-medium text-gray-700">Son Pham, <span className="font-light text-gray-500">27</span></h1>
    ...
    <p className="mt-2 text-gray-500">Arizobna State University</p>
  </div>
