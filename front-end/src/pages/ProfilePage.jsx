...
<svg xmlns="http://www.w3.org/2000/svg" class="h-24 w-24" viewBox="0 0 20 20" fill="currentColor">
  ...
  <div class="mt-20 text-center border-b pb-12">
    <h1 class="text-4xl font-medium text-gray-700">Son Pham, <span class="font-light text-gray-500">27</span></h1>
    <p class="font-light text-gray-600 mt-3">Tempe, Arizona</p>
    <p class="mt-8 text-gray-500">Solution Manager - Creative Tim Officer</p>
    <p class="mt-2 text-gray-500">Arizobna State University</p>
  </div>
