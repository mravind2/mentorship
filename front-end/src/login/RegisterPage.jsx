    ...
    <div className="flex flex-col justify-center items-center mt-4 pt-48 max-w-md mx-auto">
      <HeaderSection/>
            ...
            <form className="max-w-md mx-auto" onSubmit={registerUser}>
                <input type="name" placeholder="Name" className="w-full border my-1 py-2 px-3 rounded-2xl"
                    value={name}
                    onChange={ev => setName(ev.target.value)}/>
                <input type="email" placeholder="Email" className="w-full border my-1 py-2 px-3 rounded-2xl"
                    value={email}
